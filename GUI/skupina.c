...
//
//SINGLE field, da sa pouzit aj pre
//VYBER KOMU CHCES PISIELAT SPRAVY
//PRI VYMAZANI KONTA NA HESLO
//VYBRATIE SUBORU NA ODOSLANIE
//PRIDANIE PRIATELA
#include <ncurses.h>
#include <form.h>
#include <assert.h>
...
int main()
{
    ...
    box(win_form, 0, 0);
    mvwprintw(win_body, 1, 1, "F1 to quit, F2 add to GROUP, CHAT");
